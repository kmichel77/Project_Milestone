...
ca_vax_county_2 <- ca_vax_county %>% 
  add_column(percent_unvax = ca_vax_county$cum_unvax/ca_vax_county$susceptible *100) %>% 
  add_column(percent_fully_vax = ca_vax_county$cum_fully_vax/ca_vax_county$susceptible *100)
...
readr::write_csv(CA_flu_merge_demo, "CA_flu_merge.csv")
readr::write_csv(ca_vax_county, "ca_vax_county")
readr::write_csv(CA_flu_merge_demo_2, "CA_flu_merge_demo_2")
readr::write_csv(ca_vax_county_2, "ca_vax_county_2")
readr::write_csv(ca_vax_county, "ca_vax_county")
```
