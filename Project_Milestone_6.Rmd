...
Figure 1 demonstrates the average COVID-19 vaccination rates of all
counties in California, only including those that are fully vaccinated. The graph shows that Imperial County (94.6%) and Lassen County (33.7%) have the highest
and lowest vaccination rates among all counties. Figure 2 display that Quarter 2 (Dec '22 - Feb '23), had the highest flu incidence rates among all age groups, following Q3 (March - May '23), and Q1 (Sep - Nov '22), respectively. Q4 (June '23) had no data. 
